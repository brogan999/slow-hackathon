...
date: 2025-01-22
url: https://www.notboring.co/p/most-human-wins
word_count: 3396
---
...
**Today’s Not Boring is brought to you by 2025 Presenting Sponsor… [Rox](https://bit.ly/4h1xcSB)**

[](https://bit.ly/4h1xcSB)***[Rox](https://bit.ly/4h1xcSB) **is on a mission to empower every business owner to secure and grow their revenue. As you’ll read today:*
...
[](https://substackcdn.com/image/fetch/$s_!yD2S!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F716ba293-2ec2-4b2a-a683-d225a2ac1a31_1200x600.png)Since the [last time I wrote to you](https://www.notboring.co/p/the-return-of-magic), I have spent a lot of time meditating and a lot of time reading about meditation.
...
The idea is to strip all of that away so that you know – not intellectually, but [gnostically](https://en.wikipedia.org/wiki/Gnosis) – that “you” are a process, an undefinable part of an incomprehensible whole.
...
It’s no wonder, maybe, that I and so many others are drawn to meditation at this moment in time, that we’re allowing the [magic to return](https://www.notboring.co/p/the-return-of-magic).

Machines are now able to do things we long thought only humans could: writing, speaking, science, math, code.

[](https://substackcdn.com/image/fetch/$s_!drNY!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F61ec237b-28d7-423b-a38c-a533a2d2b70b_943x270.png)*[OpenAI o3 Benchmarks, Weights and Biases](https://wandb.ai/byyoung3/ml-news/reports/OpenAI-Introduces-o3-Pushing-the-Boundaries-of-AI-Reasoning--VmlldzoxMDY3OTUxMA#:~:text=In%20competition%2Dlevel%20mathematics%2C%20o3,o1%20and%20its%20preview%20version.)*This is the **Great Commoditization**.
...
[](https://substackcdn.com/image/fetch/$s_!jo9T!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F080e4d65-c481-41e4-844a-0463129de24c_908x360.png)It was Grossmann who realized that Riemannian geometry and tensor calculus, both of which existed purely in the world of pure mathematics because physics hadn't yet had a need for them, might do the trick. God doesn’t play dice: he had the math waiting when Einstein needed it, and Grossmann to bridge the gap.

They bridged the gap in 1912 and 1913. The two wrote a paper together, “[Entwurf](https://www.icra.it/MG/doc/Einstein_Entwurf_1913.pdf),” coming close to General Relativity (GR), but the equations weren’t quite right yet.
...
[](https://substackcdn.com/image/fetch/$s_!cDhB!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa1fcb8f8-2100-4a9c-80fd-4a226404d54f_952x279.png)I told it I was Einstein, gave it my happiest thought, and asked it to help me with the math.
...
It [has been said](https://x.com/jordihays/status/1879692440090849387) that “the only alpha left in life is sitting in rare books and manuscripts, & scrolls that OpenAI hasn’t fed into the machine yet. Your job is to find them, read them, and destroy them before they get to them.”
...
[](https://docsend.com/view/csjmsdm3s8u9942s)[Get the Strategy Memo PDF (Humans Only)](https://docsend.com/view/csjmsdm3s8u9942s)
...
Last year, I might have just hit send on a polished version of one of those earlier drafts. Everything was set up to do that: we booked sponsors into individual dates, and had a packed calendar. (Awesome work, [Nancy](https://x.com/nncxu)!) I wouldn’t have sent anything I wasn’t proud of, but I would have slammed coffee and sprinted to the deadline. I can’t tell you how many essays I reworked starting at 4am on Tuesday morning last year. And it worked well enough; I was happy with last year’s writing, though it can always improve.
...
One thing we did was change how we do sponsors. We now have three presenting sponsors for 2025 that I’m honored to be telling you about more consistently: [Rox](https://bit.ly/4h1xcSB), [Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter), and [Vanta](https://www.vanta.com/notboring). If you need sales, finance, or compliance – and every company does – go say thanks to them to kick us off on the right foot. Importantly, they don’t have set dates. Whenever I send an essay, one of the three will sponsor it. So if a piece just isn’t there, I don’t hit send.
...
That, too, weirded me out! I’ve been worried that I’ve gotten too chill and detached, that I’d “one shotted” myself as the kids say. I haven’t felt very stressed, when in the past, not sending anything for a few weeks would have really stressed me out. But [Trust the Process](https://www.notboring.co/p/trust-the-process), as they say.
...
At Not Boring, we’re going to experiment a ton. [Aman](https://x.com/amanmatreja) and [Sehaj](https://x.com/pasricha_sehaj) are cooking up new tools, like the agents behind [Boring News](https://x.com/_BoringNews), *and *the three of us are coming up with ideas for things we couldn’t have previously done without them. We want to use more compute per person than any other fund.  
...
*And thanks to our 2025 Presenting Sponsors who make deeper explorations like this possible: **[Rox](https://bit.ly/4h1xcSB), [Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter), and [Vanta](https://www.vanta.com/notboring)**. Get your company set up right to start the year. **[Rox](https://bit.ly/4h1xcSB), [Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter), and [Vanta](https://www.vanta.com/notboring).***
