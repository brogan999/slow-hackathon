---
title: "Weekly Dose of Optimism #181"
date: 2026-02-20
url: https://www.notboring.co/p/weekly-dose-of-optimism-181
word_count: 1599
---
...
We are also introducing a new segment for not boring world members: Scientific Breakthroughs from [Ulkar Aghayeva](https://x.com/ulkar_aghayeva). In December, we [shared](https://www.notboring.co/p/weekly-dose-of-optimism-174) *[Frontier of the Year 2025](https://frontier2025.netlify.app/), *in which Ulkar, Gavin Leech, and Lauren Gilbert reviewed 202 pieces of scientific news from the year and assigned a score based on a probability each generalizes and how big it would be if they did. We loved it, so we asked Ulkar to do a roundup of the most important stories in science, which she did this week.
...
**(1)** **[Heron Power Raises $140M to Build 40GW Solid State Transformer Factory](https://www.canarymedia.com/articles/climatetech-finance/heron-power-raises-140m-electrical-transformers)**

Everything that can go electric economically will, including the grid itself.

[Heron Power](https://heronpower.com/), founded by former Tesla SVP of Powertrain and Energy Drew Baglino, raised $140 million in a Series B led by a16z American Dynamism to build solid state transformers. This is pure not boring catnip: power electronics from the guy in charge of a lot of the Tesla power electronics stuff we wrote about in *[The Electric Slide](https://www.notboring.co/p/the-electric-slide)*, [a16z](https://www.notboring.co/p/a16z-the-power-brokers) putting its new funds to work, and [fixing the grid](https://www.notboring.co/p/base-power-company) by attacking one of its key [constraints](https://www.notboring.co/p/power-in-the-age-of-intelligence).
...
Heron isn’t the only company making solid state transformers. I hope they all do great. But I do want to call out one competitor: Raleigh-based DG Matrix, whose co-founder and CTO is Subhashish Bhattacharya, a professor at NC State University who is a long-time collaborator of… B. Jayant Baliga, the inventor of the IGBT, The GATEway of India, the hero of [the Power Electronics section of The Electric Slide](https://www.notboring.co/i/171945788/power-electronics)!
...
**(2)** **[DoW Transports a Valar Atomics Nuclear Reactor to Utah on a C-17](https://x.com/isaiah_p_taylor/status/2023083012083376448?s=20)**
...
In other nuclear news, [Lockheed Martin is investing in Radiant Nuclear](https://x.com/RadiantNuclear/status/2023804887893446891?s=20), which we [wrote about in 2024](https://www.notboring.co/p/radiant), as it prepares to turn on its first reactor at the DOME this summer. Defense is starting to play offense on nuclear.

**(3) [Single vaccine could protect against all coughs, colds and flus, researchers say](https://www.bbc.com/news/articles/cx2g8rz7yedo)**
...
**(5) [The US Government is Going to Release the ET, UAP, and UFO Files](https://x.com/WhiteHouse/status/2024654469745480105?s=20)**
