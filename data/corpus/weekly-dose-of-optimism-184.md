...
date: 2026-03-13
url: https://www.notboring.co/p/weekly-dose-of-optimism-184
word_count: 2264
---
...
**Today’s Weekly Dose is brought to you by… [Ramp Sheets](https://ramp.com/sheets?source=notboring)**

*A few weeks ago, I wrote that I [wrote](https://www.notboring.co/p/power-in-the-age-of-intelligence) that “a Ramp engineer with an AI will build something better than a CFO with an AI.” **[Ramp Sheets](https://ramp.com/sheets?source=notboring)** is exactly what I’m talking about. *
...
***[Ramp Sheets](https://ramp.com/sheets?source=notboring)** skips a lot of that.*
...
*Best part: [anyone can use Ramp Sheets today for free](https://ramp.com/sheets?source=notboring). You don’t need to be a Ramp customer to try it (but why wouldn’t you be?).*

[Try Ramp Sheets Free](https://ramp.com/sheets?source=notboring)

**(1) [Swift Solar Acquires Meyer Burger to Build Gigawatt-Scale Solar Factory](https://www.corememory.com/p/the-last-chance-at-solar-perovskites-swift-solar)**

**“If your technology is so good, why aren’t you using it to compete?”**

In *[Power in the Age of Intelligence](https://www.notboring.co/p/power-in-the-age-of-intelligence)*, I wrote that that’s a question I’d like to see more investors ask. If the technology you’re building with is so much better, why in the world are you just selling it to someone else as a component? Why not just make a better end product?

Joel Jean at [Swift Solar](https://www.swiftsolar.com/) said, “Ok bet.”

I met Joel a few years back on an introduction from his brother Neal, the co-founder and CEO of [Beacons](https://beacons.ai/). Joel, like Neal, is a genius, with a PhD in electrical engineering from MIT, and he was putting that genius to work by making silicon-perovskite tandem solar cells work.
...
But I love it. Pressing a technological advantage into vertical integration and competing directly is the kind of thing that gets my heart racing. And this echoes a deal that hits close to home. A few weeks into Puja’s time at [Harry’s](https://www.harrys.com/en/), she told me the 10-month-old startup was [acquiring one of the world’s oldest and best blade manufacturers, Germany’s Feintechnik](https://techcrunch.com/2014/01/22/10-month-old-harrys-lands-122-5m-buys-93-year-old-factory-to-go-toe-to-toe-with-gillette-and-schick/). That has been an incredibly successful partnership.

There’s something about a the US innovation / German manufacturing tandem.

**(2) [Reflect Orbital Built a Space Mirror](https://x.com/bennbuilds/status/2031824405194821703?s=20)**
...
Not so fast, says [Reflect Orbital](https://www.reflectorbital.com/). CEO Ben Nowack just announced that the company had made a solar mirror, one of four huge guys that will go up on each satellite, stop the photons’ getaway, and redirect them down to Earth.
...
Efficiency is one of solar’s challenges, but a bigger one is one that seemed almot insurmountable: the sun only really shines strongly enough for max solar output for 4-6 hours a day. What if it could shine on solar farms - out in the desert, away from homes ([where it wouldn’t imapact our sleep, Huberman](https://x.com/hubermanlab/status/2031034617382498487?s=20)) - round the clock?

Solar farm economics would get ridiculous, solar would get much cheaper, we’d get a lot more of it, and we’d be able to power all sorts of [new, better electric things](https://www.notboring.co/p/the-electric-slide).

Mostly, though, I’m sharing because that video is a bright spot in a sea of sameness.

**(3) [The First Multi-Behavior Brain Upload](https://x.com/alexwg/status/2030217301929132323?s=20)**

*Dr. Alex Wissner-Gross* *for* *Eon Systems*

As big a week as it was for solar, it may have been an even bigger week for brains.

A couple of weeks ago, an Australian company [Cortical Labs](https://corticallabs.com/) grew brain cells on a microchip and taught it to do the first thing hackers try to do on any new computer, from TI-83s to ATMs to pregnancy tests to vape screens: play Doom. And yup, it could play Doom.
...
The team is careful not to oversell the accomplishment, and Dr. Doris Tsao at Astera Neuro has a [good list of thoughts on connectonomics and uploads here](https://x.com/doristsao/status/2030865647966536103) which basically says, “This is awesome, but we’ll get further by understanding instead of blindly mapping, and anyway, it’s going to be really expensive to map bigger and more complex brains.”
...
- Scientists revive activity in frozen mouse brains for the first time. A team in Germany made progress on cryopreserving and thawing mouse brains that leaves some of the processes necessary for brain functioning like neuronal firing, cell metabolism, and brain plasticity intact. A researcher at another lab cautioned that we’re still a long way away from freezing ourselves and waking up in the future, but he also said, “This kind of progress is what gradually turns science fiction into scientific possibility.”

OK, so maybe all of this is just very sci-fi.

**(4) [Emergent Quantization from a dynamic vacuum](https://journals.aps.org/prresearch/pdf/10.1103/l8y7-r3rm), or Zero Point Energy**
...
**(5) [Replit Launches Agent 4](https://x.com/amasad/status/2031755113694679094?s=20)**

*Amjad Masad for Replit*

Look, I’m biased. I’m an investor in Replit. I [wrote about them in 2021](https://www.notboring.co/p/replit-remix-the-internet) and [predicted they’d be a $100 billion company](https://x.com/packyM/status/1468943300405178377?s=20). This week, they raised at a $9 billion valuation, so we’re getting there.
...
I’m going to be playing with it this weekend. If you have some time, [build something](https://replit.com/).
