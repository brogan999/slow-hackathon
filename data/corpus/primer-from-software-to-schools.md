...
date: 2025-03-05
url: https://www.notboring.co/p/primer-from-software-to-schools
word_count: 12730
---
...
[](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter)*[Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter) reached a new valuation this week: $13 billion. The [Financial Times reported](https://www.ft.com/content/458a96ba-e022-4b06-b028-b4bc41a969b6) that [Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter) is now processing $55 billion in payments on an annualized basis, up from $10 billion two years ago. It is a company that is here to stay.*
...
*Whether you’re inventing the future, leading a Fortune 500, or running a small business like Not Boring, Ramp has the tools your business needs to grow intelligently. It streamlines approvals, automates expense management, delivers real-time insights, and seamlessly syncs with ERP systems. Your finance team gets the control and visibility they need, without the busywork.*

*That’s why [Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter) is trusted by 30,000+ companies big and small, including Shopify, Anduril, Barry’s, Stripe, CBRE, Notion, Cursor, Kumon, and of course, Not Boring to achieve more with less. **Join us.***

*Time is money. It’s time your team upgraded to **[Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter): The Official Business Card of Not Boring, **now and for a very long time to come.*
...
Over the past five years, I’ve written Deep Dives on 80 companies. I’ve only written about one company more than once: [Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter). They just announced a new $13 billion valuation, up ~43x since the [first time I wrote about them in 2020](https://www.notboring.co/p/ramp-the-card-sized-finance-team).
...
For the first one, there’s no better company to follow up with than **[Primer](https://primer.com/)**. 

When I first [wrote about Primer in April 2022](https://www.notboring.co/p/primer-the-ambitious-home-for-ambitious), they were a mostly online home for ambitious kids to learn in Clubs with other ambitious kids outside of school that was just getting ready to launch its first Microschools. They have since gone all-in on in-person Microschools based on the realization that if you want to actually fix K-12 education, you can’t nibble around the edges with software; you have to build a better version of the system and compete.

Primer is running the [Vertical Integrator](https://www.notboring.co/p/vertical-integrators) strategy for education, where the sclerotic incumbent is the US public school system. It’s the kind of incumbent that you don’t even really realize you can compete with, until you realize that you can, and then once you do, realize that you must.
...
So today, I’m sharing a short essay on my refreshed thesis, a Follow-Up Conversation with Primer founder and CEO Ryan Delk, and a transcript. You can also watch on [YouTube](https://youtu.be/jR3-MFVT0bY) or [listen on Spotify](https://open.spotify.com/episode/13PA3bKVPOSvTX0RlsxRPm?si=nNnoWr_VTBuGJFkDF2I3ng). Let me know what you think of this format.

Let’s get to it.

# **Primer: From Software to Schools**

[](https://substackcdn.com/image/fetch/$s_!Yy3_!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8863f27d-99ee-4c5f-99f8-b58a1af1886a_1200x600.png)Ryan Delk used to begin [Primer’s](https://primer.com/) investor updates with a “Tweet-Length Summary”:
...
**[https://www.notboring.co/p/primer-the-ambitious-home-for-ambitious](https://www.notboring.co/p/primer-the-ambitious-home-for-ambitious)** 
...
[](https://substackcdn.com/image/fetch/$s_!TCUq!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fac688462-c101-42e1-994e-203356a46ed7_910x507.png)*Primer Deep Dive, April 2022*And it was going really well. It was growing. Kids *loved *Primer’s Clubs. 
...
Since then, Ryan has begun every [Primer](https://primer.com/) investor update with a reminder:
...
Cost is an important factor when you’re competing against free. In Florida and Arizona, where Primers exist today (Primer is announcing another state soon), parents can use their state’s school choice program to offset much of the cost of school. These programs are growing both in terms of the number of states offering them and the size of the programs, something I’ve seen first hand as an investor in [Odyssey](https://withodyssey.com/), which helps state governments administer their school choice programs. (For those getting mad just reading the words “school choice,” watch the video.)
...
This is the Vertical Integrator mantra: **better, faster, cheaper, at higher margins**. Primer is applying it to a $1.5 trillion US education market ($870 billion of which is [spent on public elementary and secondary schools](https://www.statista.com/statistics/184228/expenditures-for-public-and-private-elementary-and-secondary-schools/)) – a gargantuan market whose impact as a multiplier on all other markets is even larger.
...
That’s all for today. Please let me know what you think about this format, and if you want to stop reading and just get to work fixing education by working at Primer or launching a Microschool, check out **[Primer’s career page](https://primer.com/careers)**.

We’ll be back in your inbox with a Weekly Dose on Friday, by which point I fully expect you to have your company set up on **[Ramp](https://ramp.com/business-cards?utm_source=substack&utm_medium=email&utm_campaign=not-boring-newsletter)**.
